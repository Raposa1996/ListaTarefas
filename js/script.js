...
function updateTaskList() {
    ...
    function updateTaskList() {
        ...
        tasks.forEach((task, index) => {
            const taskItem = document.createElement('li');
            taskItem.classList.add('task');
            if (task.done) taskItem.classList.add('done'); // Marca a tarefa como concluída e aplica a classe 'done'
    ...
    function toggleTask(index) {
        tasks[index].done = !tasks[index].done; // Alterna o estado 'done' da tarefa
